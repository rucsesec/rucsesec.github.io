...
int main() {
  ...
  srand(time(NULL));  //initialized the random seed generator
  ...
  while (!flag && i<=n) {
    a = rand() % 6 + 1;  //randomly generate a number between [1, 6]
    b = rand() % 6 + 1;  //randomly generate a number between [1, 6]
    c = rand() % 6 + 1;  //randomly generate a number between [1, 6]
    d = rand() % 6 + 1;  //randomly generate a number between [1, 6]
    e = rand() % 6 + 1;  //randomly generate a number between [1, 6]
    f = rand() % 6 + 1;  //randomly generate a number between [1, 6]
    printf("Loop %d: %d %d %d %d %d %d", i, a, b, c, d, e, f);
